...
public enum Drones {
    PIXEL("drone.fpv-drone.pixel",
            0.225, 0.125, 0.01, 0.05, 0.4, 1, 5),
    VOXEL_RACER_ONE("drone.fpv-drone.voxel_racer_one",
            0.55, 0.3, 0.5, 0.135, 65, 1, 45),
    VOYAGER("drone.fpv-drone.voyager",
            0.9, 0.2, 1.2, 0.2, 55, 0.8, 20);
